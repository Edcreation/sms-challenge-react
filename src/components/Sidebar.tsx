...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 text-white  z-[9999] flex h-screen w-64 max-w-[390px] md:w-80 flex-col overflow-y-hidden  duration-300 ease-linear lg:static lg:translate-x-0 ${
        sidebarOpen ? 'translate-x-0' : '-translate-x-full'
      }`}
      style={{ background: '#03256C' }}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 pl-3 pr-5">
        <NavLink to="/">
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
        <nav className="md:pt-5 md:p-2 p-5">
          {/* <!-- Menu Group --> */}
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/send' || pathname.includes('send')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-1 mb-5 flex flex-col gap-2 text-slate-300 pl-10">
                          <li>
                            <NavLink
                              to="/home/send-message"
                              className={({ isActive }) =>
                          ...
                          <li>
                            <NavLink
                              to="/home/send-message/recipient"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/home/settings' || pathname.includes('settings')
                }
              >
                {(handleClick, open) => {
                  return (
